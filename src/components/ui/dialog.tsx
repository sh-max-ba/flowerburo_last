...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "sticky bottom-0 -mx-5 -mb-5 flex flex-col-reverse gap-2 rounded-b-2xl border-t border-border/40 bg-muted/30 p-5 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn(
        "text-sm text-zinc-600 *:[a]:underline *:[a]:underline-offset-3 *:[a]:hover:text-foreground",
        className
      )}
      {...props}
    />
