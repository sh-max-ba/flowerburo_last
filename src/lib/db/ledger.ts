  ...
  client
    .prepare(
      `INSERT INTO cash_transactions (
        shift_id, order_id, sale_id, customer_id, deal_id, user_id, source_shift_id, reverses_id, type, payment_method, amount, comment
      ) VALUES (
        @shiftId, @orderId, @saleId, @customerId, @dealId, @userId, @sourceShiftId, @reversesId, @type, @paymentMethod, @amount, @comment
      )`
    )
    .run({
